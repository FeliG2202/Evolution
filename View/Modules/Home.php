...
$usuarioRol = new UsuarioRolesControlador();
$roles = $usuarioRol->consultarUsuarioIdRolesControlador();
$usuarioRol->cargarInicioRolControlador();
?>
					...
					<div class="form-group">
						...
						<select name="idRol" id="idRol" class="form-control">
							...
							foreach ($roles as $key => $value) {
								print '<option value="'.$value['idRol'].'">'.$value['rolesdescripcion'].'</option>';
							}
