...
<div class="col-sm-12 col-md-10 col-lg-9 col-xl-9 mx-auto mt-5 mb-5 p-4">
	<div class="form-row">
		<div class="form-group col-sm-12 col-md-6 col-lg-4 col-xl-4">
			<div class="card">
					<img src="Assets/Img/Ejercicios/Ejercicio1.png" class="card-img-top">
				<div class="card-body">
		...
		<div class="form-group col-sm-12 col-md-6 col-lg-4 col-xl-4">
			<div class="card">
				<img src="Assets/Img/Ejercicios/Ejercicio2.png" class="card-img-top">
				<div class="card-body">
		...
		<div class="form-group col-sm-12 col-md-6 col-lg-4 col-xl-4">
			<div class="card">
				<img src="Assets/Img/Ejercicios/Ejercicio3.png" class="card-img-top">
				<div class="card-body">
