...
<div class="col-lg-10 mx-auto mt-5 mb-5 bg-white p-4 shadow-sm rounded">
	...
	<form method="POST">
		<select name="idTipoCuestionario" id="idTipoCuestionario" class="form-control" required>
		...
		<br>
		<input type="submit" name="verCuestionario" value="Ver Cuestionario" class="btn btn-success mb-3">
			...
			<table class="table table-hover table-sm">
				...
				<tbody>
					...
					foreach ($datosPregunta as $key => $value) {
						...
						<td class="w-75">'.$value["preguntadetalle"].'</td>
						<td class="w-25">
